...
<Callout type="info">
  Looking for AI/LLM observability? Check out the dedicated [@databuddy/ai package](/docs/ai).
</Callout>
...
<Callout type="info">
  AI/LLM observability is now in a separate package. See the [full AI documentation](/docs/ai) for details.
</Callout>
